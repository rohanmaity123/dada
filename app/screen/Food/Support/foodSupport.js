...
class FoodSupport extends React.Component{
    render(){
        const Width = Dimensions.get('screen').width;
        return(
            <View>
                <AllNormalHeader name="Food Support" />
                <View style={{marginTop:25,width:'95%',alignSelf:'center'}}>
                    <Text style={{ textAlign: 'center',fontWeight:'bold' }}>Text Us For Your Food Support</Text>
