...
class EStoreDeleveryType extends React.Component{
    render(){
        return(
            <View style={{flex:1,backgroundColor:'#f8bc06'}}>
                ...
                <View style={{alignItems:'center',marginTop:250}}>
                    <TouchableOpacity onPress={()=>this.props.navigation.navigate('EStoreCatagory')}>
...
export default EStoreDeleveryType;